...
export function OverviewTab() {
  const {
    snapshot, rangeDays, setRangeDays, refreshSnapshot, refreshPRs,
    refreshTeamSecurity, refreshRepositoryConfig, setSelectedTab,
    setSelectedPrId, apiStatus, wsStatus, running, appendLog,
  } = useDashboard();
