...
- [ ] 1. Setup NestJS project dan konfigurasi dasar
  ...
  - [ ] 1.2 Configure TypeScript dan build tools
  ...
  - [ ] 1.3 Setup folder structure dan modules
...
- [ ] 2. Setup TypeORM dengan SQLite dan entities
  - [ ] 2.1 Install dan configure TypeORM dependencies
  ...
  - [ ] 2.2 Create entity classes untuk database schema
  ...
  - [ ] 2.3 Setup repository providers dan test database operations
  ...
  - [ ]* 2.4 Write property test untuk TypeORM repository injection
  ...
  - [ ]* 2.5 Write property test untuk database transactions
  ...
  - [ ]* 2.6 Write property test untuk entity relations
...
- [ ] 3. Setup ConfigModule dan environment configuration
  - [ ] 3.1 Configure NestJS ConfigModule
...
- [ ] 5. Implement LoggerModule dan custom logger
  - [ ] 5.1 Create custom logger service dengan daily rotation
  ...
  - [ ] 5.2 Configure logger untuk HTTP request logging
  ...
  - [ ]* 5.3 Write unit tests untuk logger functionality
